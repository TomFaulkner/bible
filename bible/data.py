...
def bible_data(translation=None):
    ...
    # Versions modify base data. Also used as default if no version is provided
    bible = [
        {
            'testament': 'OT',
            'verse_counts': [31, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20,
        ...
        {
            'testament': 'OT',
            'verse_counts': [22, 25, 22, 31, 23, 30, 25, 32, 35, 29, 10, 51,
        ...
        {
            'testament': 'OT',
            'verse_counts': [17, 16, 17, 35, 19, 30, 38, 36, 24, 20, 47, 8, 59,
        ...
        {
            'testament': 'OT',
            'verse_counts': [54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16,
        ...
        {
            'testament': 'OT',
            'verse_counts': [46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32,
        ...
        {
            'testament': 'OT',
            'verse_counts': [18, 24, 17, 24, 15, 27, 26, 35, 27, 43, 23, 24,
        ...
        {
            'testament': 'OT',
            'verse_counts': [36, 23, 31, 24, 31, 40, 25, 35, 57, 18, 40, 15,
        ...
        {
            'testament': 'OT',
            'verse_counts': [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25,
        ...
        {
            'testament': 'OT',
            'verse_counts': [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31,
        ...
        {
            'testament': 'OT',
            'verse_counts': [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33,
        ...
        {
            'testament': 'OT',
            'verse_counts': [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21,
        ...
        {
            'testament': 'OT',
            'verse_counts': [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40,
        ...
        {
            'testament': 'OT',
            'verse_counts': [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16,
        ...
        {
            'testament': 'OT',
            'verse_counts': [11, 20, 32, 23, 19, 19, 73, 18, 38, 39, 36, 47,
                             31],
            'name': 'Nehemiah',
            'abbrs': ['neh', 'ne', 'nehem']
        },
        ...
        {
            'testament': 'OT',
            'verse_counts': [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25,
        ...
        {
            'testament': 'OT',
            'verse_counts': [6, 12, 8, 8, 12, 10, 17, 9, 20, 18, 7, 8, 6, 7, 5,
                             ...
                             7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21,
                             26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14,
                             9, 6],
            'name': 'Psalms',
        ...
        {
            'testament': 'OT',
            'verse_counts': [33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28,
        ...
        {
            'testament': 'OT',
            'verse_counts': [31, 22, 26, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22,
        ...
        {
            'testament': 'OT',
            'verse_counts': [19, 37, 25, 31, 31, 30, 34, 22, 26, 25, 23, 17,
        ...
        {
            'testament': 'OT',
            'verse_counts': [28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28,
        ...
        {
            'testament': 'OT',
            'verse_counts': [11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14,
                             16, 9],
            'name': 'Hosea',
            'abbrs': ['hos', 'ho']
        },
        ...
        {
            'testament': 'OT',
            'verse_counts': [21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9,
                             21],
            'name': 'Zechariah',
            'abbrs': ['zech', 'zec']
        },
        ...
        {
            'testament': 'NT',
            'verse_counts': [25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50,
        ...
        {
            'testament': 'NT',
            'verse_counts': [45, 28, 35, 41, 43, 56, 37, 38, 50, 52, 33, 44,
                             37, 72, 47, 20],
            'name': 'Mark',
            'abbrs': ['mar', 'mk']},
        {
        ...
        {
            'testament': 'NT',
            'verse_counts': [51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50,
        ...
        {
            'testament': 'NT',
            'verse_counts': [26, 47, 26, 37, 42, 15, 60, 40, 43, 48, 30, 25,
        ...
        {
            'testament': 'NT',
            'verse_counts': [32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21,
                             14, 23, 33, 27],
            'name': 'Romans',
            'abbrs': ['rom', 'ro', 'rm']
        },
        {
            'testament': 'NT',
            'verse_counts': [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31,
                             13, 40, 58, 24],
            'name': '1 Corinthians',
        ...
        {
            'testament': 'NT',
            'verse_counts': [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21,
                             14],
            'name': '2 Corinthians',
        ...
        },
        {
            ...
            'abbrs': ['1thes', '1thessalonians', '1thess', '1th', '1 thess',
                      '1 thes', '1 th']
        },
        {
            'testament': 'NT',
            ...
            'abbrs': ['2thes', '2thessalonians', '2thess', '2th', '2 thess',
                      '2 thes', '2 th']
        },
        {
            'testament': 'NT',
            ...
            'name': '1 Timothy',
            'abbrs': ['1tim', '1tm', '1 tm', '1timothy', '1ti', '1 tim',
                      '1 ti']
        },
        {
            'testament': 'NT',
            ...
            'name': '2 Timothy',
            'abbrs': ['2tim', '2tm', '2 tm', '2timothy', '2ti', '2 tim',
                      '2 ti']
        },
        {
            'testament': 'NT',
        ...
        {
            'testament': 'NT',
            'verse_counts': [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29,
                             25],
            'name': 'Hebrews',
            'abbrs': ['heb', 'he']
        },
        ...
        },
        {
            ...
            'name': '1 Peter',
            'abbrs': ['1pet', '1p', '1pe', '1 pe', '1pt', '1pe', '1 pet',
                      '1 pt', '1 pe']
        },
        {
            'testament': 'NT',
            ...
            'name': '2 Peter',
            'abbrs': ['2pet', '2p', '2pe', '2 pe', '2pt', '2pe', '2 pet',
                      '2 pt', '2 pe']
        },
        {
            'testament': 'NT',
        ...
        {
            'testament': 'NT',
            'verse_counts': [20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 17,
    ...
    if translation:
        if translation in ('RSV', 'ESV'):
            ...
            # bible = add_omission(bible, 43, 8, 1, 11)    # John 8:1-11
            # -- Need to double check this - may just be foot note
...
def add_omission(bible, book, chapter, verse, endverse=None):
    """Add verse or range of verses as omitted from this translation."""
